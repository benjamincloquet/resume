...
const Project = ({
  ...
  <div className={`flex-grow mx-2 my-2 ${large ? 'w-full' : 'w-1/3'}`}>
    <div className="bg-white px-4 py-4 border-4 w-full border-green-dark hover:border-black hover:shadow transition transform hover:-translate-x-2 hover:-translate-y-2 ease-in-out duration-500">
      <a href={link}>
