...
const Header = () => (
  <header className="w-full h-screen py-10 flex flex-col justify-between items-center bg-white">
    ...
    <InteractiveText className="flex-grow self-stretch text-center">
    ...
    <div className="flex flex-col items-center">
      ...
      <svg className="w-12 sm:w-6 animate-bounce" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
